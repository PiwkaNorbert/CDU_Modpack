...
// console.log(timesVoted);
  ...
  return (
    <>
      <Header />
      <div className="grid w-screen justify-normal text-text self-start md:justify-center bg-bg ">
      ...
      <div className="  bg-bg shadow-2xl shadow-bg/20 dark:shadow-none  lg:my-2 lg:rounded-xl lg:max-w-4xl lg:justify-center lg:place-self-center ">
        ...
        >
          ...
          <div className={`grid mx-4 items-center `}>
            <div className=" my-4 grid px-4 sm:grid-cols-2 space-x-4 ">
