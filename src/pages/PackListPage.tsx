  ...
  return (
    <>
      ...
      <div className="grid  justify-normal self-center md:justify-center  lg:justify-center">
        ...
        <div className="my-4  overflow-hidden bg-bkg-100  shadow-mainContainer dark:shadow-none dark:border dark:border-bkg-0/20  md:rounded-xl     lg:max-w-[1000px] ">
          {/* map the data variable in a grad 4x2  */}
          <div className="text-bkg-100 dark:text-bkg-0 flex items-center justify-between border-b-4 border-bkg-200 bg-bkg-600 p-3 text-xl  space-x-4 ">
            <p>Modpacks</p>
            {/* Show this button if you're logged in and a staff member */}
            <a href="/modpacks" className="text-content   rounded-md  bg-bkg-400 px-3 py-1 text-sm ">
             Add Modpack
            </a>
          </div>
