...
const CreateModpackSuccess = () => {
  return (
    <div className="flex h-full flex-col items-center justify-center gap-4 px-4 py-20">
      ...
      <Link
        to={"/"}
        className="flex min-w-min cursor-pointer items-center gap-2 rounded-md border border-blue-500 px-4 py-2 text-sm text-blue-500 hover:bg-sec/20 hover:text-blue-700 dark:border-blue-300 dark:text-blue-300 dark:hover:bg-hover-2 dark:hover:text-blue-500"
      >
        <svg
