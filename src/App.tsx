...
const LinkedRoutes = lazy(() => import("./Utils/LinkedRoutes.tsx"));
const AdminRoutes = lazy(() => import("./Utils/AdminRoutes.tsx"));
...
const CreateModpackSuccess = lazy(
  () => import("./Pages/SuggestPack/CreateModpackSuccess.tsx")
);
const ArchivedPackListPage = lazy(
  () => import("./Pages/ArchivedPackListPage.tsx")
);
const SuggestedPackListPage = lazy(
  () => import("./Pages/SuggestedPackListPage.tsx")
);
const CreateModpack = lazy(
  () => import("./Pages/SuggestPack/CreateModpack.tsx")
);
  ...
  return (
    <ThemeProvider>
      <BrowserRouter>
        ...
        <BaseLayout>
          <Suspense
            fallback={<Loading size="la-lx" fullScreen={true} other="" />}
          >
            <Routes>
